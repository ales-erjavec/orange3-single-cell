...
# TODO: test with real data and log transform
# TODO: test stacking of preprocessors
# TODO: unify processing for class variables
...
class OWNormalization(widget.OWWidget):
    ...
    def __init__(self):
        ...
        # self.batch_attrs = DomainModel(order=(DomainModel.CLASSES,
        #                                       DomainModel.METAS),
        self.batch_attrs = DomainModel(order=(DomainModel.METAS, ),
